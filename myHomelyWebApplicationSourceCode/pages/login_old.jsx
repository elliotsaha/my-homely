...
export default function login() {
  ...
  const responseFacebook = (response) => {
    ...
    axios({
      method: "POST",
      url: `${process.env.NEXT_PUBLIC_SERVER_API}/api/user/facebooklogin`,
  ...
  const onSubmit = (values, functions) => {
    axios({
      method: "POST",
      url: `${process.env.NEXT_PUBLIC_SERVER_API}/api/user/login`,
      data: {
        email: values.email,
                ...
                <div className={classes.inner}>
                  ...
                  <div className={classes.forgotPassContainer}>
                    <div className={classes.sub}>
                      ...
                      <span className={classes.link}> Reset</span>
                    </div>
                  </div>
